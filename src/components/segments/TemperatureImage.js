...
export default function TemperatureImage(props) {
    ...
    const weatherTypes = {
        ...
        "light intensity drizzle rain": DrizzleIcon, "shower drizzle": DrizzleIcon, "light rain": LightRainIcon, "moderate rain": LightRainIcon, "broken clouds": PartlyCloudyIcon,
